...
namespace Biblioteka
{
    ...
    {
        public List<Reader> czytelnicy = new List<Reader>();
        ...
        public List<Book> GetBookList() {
            return ksiazki.Select(kvp => kvp.Value).ToList();
        }

        public List<Reader> GetReadersList() {
            return czytelnicy.ToList();
        }

        public List<Borrow> GetBorrowsList() {
            return wypozyczenia.ToList();
        }

        public List<Book> Books { get { return ksiazki.Select(kvp => kvp.Value).ToList(); } }
        public List<Reader> Readers { get { return czytelnicy.ToList(); } }
        public List<Borrow> Borrows { get { return wypozyczenia.ToList(); } }
    }
